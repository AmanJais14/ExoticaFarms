        ...
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-6 sm:mt-12 md:mt-28 max-w-4xl mx-auto animate-fade-in delay-1000 px-4 md:px-0">
              ...
              <div className="w-3/5 md:w-full bg-black/30 backdrop-blur-xs rounded-md md:rounded-xl p-2 md:p-4 shadow-lg border border-white/20 hover:bg-white/20 transition-all duration-300 h-12 md:h-20">
                <div className="flex items-center gap-1.5 md:gap-3 h-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xs md:text-base font-bold text-white leading-tight">8-12%</div>
                    <div className="text-xs text-white/80 leading-tight">Land Appreciation</div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-3/5 md:w-full bg-black/30 backdrop-blur-xs rounded-md md:rounded-xl p-2 md:p-4 shadow-lg border border-white/20 hover:bg-white/20 transition-all duration-300 h-12 md:h-20">
                <div className="flex items-center gap-1.5 md:gap-3 h-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xs md:text-base font-bold text-white leading-tight">IIM</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mt-6 sm:mt-8 mb-1 animate-scale-in delay-700 px-4 sm:px-0 md:hidden">
              ...
              <button
                className="bg-white mt-12 text-green-700 border border-white/30 px-6 sm:px-8 md:px-12 py-3 sm:py-3 md:py-4 rounded-lg sm:rounded-xl md:rounded-2xl font-semibold sm:font-bold text-sm sm:text-sm md:text-base transition-all duration-300 transform hover:scale-105 hover:shadow-glow-green backdrop-blur-md group relative overflow-hidden w-auto mx-auto min-w-[264px] sm:min-w-[264px] md:min-w-[300px]"
