...
// Import components
import Navbar from "./components/Navbar/NavbarNextjs";
...
const satellite = "/assets/satellite3.png";

// Gallery2 assets
const img1 = "/assets/gallery2/img1.jpg";
const img2 = "/assets/gallery2/img2.jpg";
...
const vdo3 = "/assets/gallery2/vdo3.mp4";
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.lintrk) {
        window.lintrk('track', { conversion_id: 'main_form_submission' });
      }

      // Track Google Ads conversion
      if (typeof window !== 'undefined' && window.gtag) {
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17078815484/main_form_conversion',
          'value': 1.0,
          'currency': 'INR'
        });
      }
      ...
      if (typeof window !== 'undefined' && window.fbq) {
        window.fbq('track', 'Lead', {
          content_name: 'Main Form Submission',
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-4">
                    ...
                    <div className="relative group">
                      ...
                      {isClient ? (
                        ...
                        <div className="w-full px-4 py-3 rounded-2xl border border-white/20 bg-white/90 text-gray-500 text-sm">
